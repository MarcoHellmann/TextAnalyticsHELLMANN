...
public class ID_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.unidue.langtech.teaching.pp.type.ID");
  ...
  public String getID(int addr) {
      ...
      jcas.throwFeatMissing("ID", "de.unidue.langtech.teaching.pp.type.ID");
